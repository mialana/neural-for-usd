...
if __name__ == '__main__':
    ...
    training_dataset = torch.from_numpy(np.load('/Users/liu.amy05/Documents/Neural-for-USD/src/nerf/data/training_data.pkl', allow_pickle=True))
    testing_dataset = torch.from_numpy(np.load('/Users/liu.amy05/Documents/Neural-for-USD/src/nerf/data/testing_data.pkl', allow_pickle=True))
